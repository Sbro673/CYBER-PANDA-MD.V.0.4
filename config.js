...
//
global.Owner = ["+94707405088"];         //If you want singal number so global.Owner = ['916297175943'] Change into your number.
global.OwnerNumber = ["+94707405088"];   //If you want singal number so global.Owner = ['916297175943'] Change into your number.
global.ownertag = ["+94707405088"];
global.OwnerName = "$asitha";
global.BotName = "$asitha";
global.packname = "🦋 │𝐂𝐘𝐁𝜩𝐑│𝐏𝜟𝐍𝐃𝐀│𝐌𝐃│𝐕➂ 🦋";                             //Do not change.
global.author = "$asitha";                               //Do not change.
